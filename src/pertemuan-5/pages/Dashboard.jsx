...
export default function Dashboard() {
  return (
    <div id="dashboard-container">
      ...
      <div
        id="dashboard-grid"
        className="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2 md:grid-cols-5"
      >
        <div
          id="dashboard-orders"
          className="flex items-center space-x-5 rounded-lg bg-white p-4 shadow-md"
        >
          <div id="orders-icon" className="rounded-full bg-green-500 p-4">
        ...
        <div
          ...
          className="flex items-center space-x-5 rounded-lg bg-white p-4 shadow-md"
        >
          <div id="delivered-icon" className="rounded-full bg-blue-500 p-4">
        ...
        <div
          ...
          className="flex items-center space-x-5 rounded-lg bg-white p-4 shadow-md"
        >
          <div id="canceled-icon" className="rounded-full bg-red-400 p-4">
        ...
        <div
          ...
          className="flex items-center space-x-5 rounded-lg bg-white p-4 shadow-md"
        >
          <div id="revenue-icon" className="rounded-full bg-yellow-400 p-4">
        ...
        <div
          ...
          className="flex items-center space-x-5 rounded-lg bg-white p-4 shadow-md"
        >
          <div id="customers-icon" className="rounded-full bg-purple-500 p-4">
            <FaUsers className="text-3xl text-white" />
          </div>
          <div id="customers-info" className="flex flex-col">
            <span id="customers-count" className="text-2xl font-bold">89</span>
            <span id="customers-text" className="text-gray-400">Total Customers</span>
          </div>
        </div>
      </div>
    </div>
